import { ADD_TO_CART,REMOVE_ITEM,SUB_QUANTITY,ADD_QUANTITY, GET_ITEM, FIND_ONE, CHECK_OUT} from './cart-type'
...
export const checkOut = id => dispatch => {
    return axios.post(`${process.env.REACT_APP_API_URL}/cart/${id}`).then(res=> {console.log(res)
        dispatch({
            type: CHECK_OUT,
            payload: res
        });
