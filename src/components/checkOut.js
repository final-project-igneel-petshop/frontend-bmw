    ...
    return (
      <div>
        ...
        <div>
          ...
          <h6> {this.props.cart[0].fullName} </h6>
          <h6> {this.props.cart[0].email} </h6>
          <h6> {this.props.cart[0].street} </h6>
          <h6> {this.props.cart[0].city} </h6>
          <h6> {this.props.cart[0].zipcode} </h6>
        </div>
        <div>
          <h5>Items ordered: </h5>
          <Table columns={columns} dataSource={this.props.cart} />
          <h1>{this.props.cart[0].totalPrice}</h1>
        </div>
      </div>
    );
  }
